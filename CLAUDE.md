...
**Field-coverage audit, 2026-08-17** (all 99 ads, measured through `GET /api/agent/ads?stage=*`). Run this before promising any integration a field — several that look central are empty in practice:
